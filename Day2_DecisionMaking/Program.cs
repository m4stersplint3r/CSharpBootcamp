...
namespace Day2_DecisionMaking
{
    class Program
    {
        public bool validInputCheck(int x)
        {
            if (x < 0 || x > 100)
            {
                return false;
        ...
        static void Main(string[] args)
        {
            ...
            while (continueInput)
            {
                ...
                {
                    validInput = program.validInputCheck(inputNum);
                }
                ...
                Console.Write(Environment.NewLine + $"{username} would you like to continue? (y/n): ");
            ...
            Console.WriteLine(Environment.NewLine + "Thanks for using my program! Bye!");
